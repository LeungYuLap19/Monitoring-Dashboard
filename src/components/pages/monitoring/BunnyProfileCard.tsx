          ...
          <div className="space-y-1">
            <div className="flex items-center gap-2">
              ...
              <span className={`text-[10px] font-bold px-2 py-0.5 rounded-full ${
                ...
                {activeBunny.gender === '公' ? t('overview.bunnyProfile.male') : t('overview.bunnyProfile.female')}
              </span>
            </div>
            <div className="text-[11px] text-slate-400 font-bold space-x-3">
              <span>{t('overview.bunnyProfile.breedLabel')} {activeBunny.breed}</span>
              <span>•</span>
              <span>{t('overview.bunnyProfile.checkInLabel')} {activeBunny.checkInDate}</span>
            </div>
          </div>
        </div>
