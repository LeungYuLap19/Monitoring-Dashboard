...
export default function ActivityLogSummary({ petName, totalActivities }: ActivityLogSummaryProps) {
  ...
  return (
    <div className="space-y-3">
      ...
      <p className="text-sm text-slate-600 leading-relaxed font-semibold bg-slate-50 p-5 rounded-2xl">
        {t('clientView.summaryText', { name: petName, count: String(totalActivities) })}
      </p>
    </div>
  );
}
